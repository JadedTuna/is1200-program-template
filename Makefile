...
# Linkscript
LINKSCRIPT := program/src/p32mx340f512h.ld

# Resources
INCLUDEDIR := program/include
SOURCEDIR := program/src
BUILDDIR := build
...
ASFLAGS += -msoft-float
# max-page-size: this *MAY* break things, but gets the file size down
LDFLAGS +=  -z max-page-size=128 -T $(LINKSCRIPT) -lc
